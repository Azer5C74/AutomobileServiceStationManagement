 ...
 * @author Tanmey Tsci6
 */
public class PendingBillsReport extends javax.swing.JPanel {

    String d = null;
    int j;
    String data[][] = {};
    String col[] = {"Num Vehicule","Num Regis","possédeur","Contact num","Catégorie","Besoin","Localisation","kilomètres","Année","Modèle","Date","date d'échéance"};
...
//        });
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        showdata("select * from addnewvehicle ORDER BY DueDate DESC" );
